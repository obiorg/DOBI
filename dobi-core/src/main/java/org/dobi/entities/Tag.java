...
public class Tag extends BaseEntity {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "tag")
    private Collection<org.dobi.entities.Persistence> persistenceCollection;
    ...
    public Collection<org.dobi.entities.Persistence> getPersistenceCollection() {
        return persistenceCollection;
    }

    public void setPersistenceCollection(Collection<org.dobi.entities.Persistence> persistenceCollection) {
